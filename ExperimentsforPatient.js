...
export default function ExperimentsforPatient({navigation,route}){
           ...
           <Text style={{ color: 'black', textAlign: 'center', marginTop: 20 }}>
               ...
               exp.map((experiment, index) => (
                ...
                >
                    ...
                    <Text style={{color:"white",textAlign:"center",paddingTop:13,fontSize:17,fontWeight:"bold"}}>Experiment {index + 1}</Text> 
